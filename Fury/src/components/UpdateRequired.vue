<template>
  <v-app id="inspire">
    <v-app-bar app color="indigo" dark>
      <v-toolbar-title>Update Required</v-toolbar-title>
    </v-app-bar>
        ...
        <v-layout align-center justify-center>
          <div class="container2">
            ...
            <v-alert prominent type="error">
              <v-row align="center">
                <v-col class="grow">
                  New Version of CStorePro POS Link is available. Please update by clicking
...
export default {
  ...
  data: () => ({
    dialog: false,
    items1: [{ title: "Chat/Help" }],
    items2: [{ title: "Knowledge Base" }],
    dialogView: 0,
    dialogData: [
      {
