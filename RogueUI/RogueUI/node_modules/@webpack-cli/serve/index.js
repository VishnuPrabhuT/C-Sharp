 ...
 * @returns {Void}
 */
const spawnNPMWithArg = (cmd) => spawn.sync("npm", ["install", "webpack-dev-server", cmd], {
    stdio: "inherit",
});
/**
 *
 ...
 * @returns {Void}
 */
const spawnYarnWithArg = (cmd) => spawn.sync("yarn", ["add", "webpack-dev-server", cmd], {
    stdio: "inherit",
});
/**
 *
        ...
        return inquirer
            ...
            if (answer.confirmDevserver) {
                return inquirer
                    ...
                    return resolve_packages_1.processPromise(spawnAction())
                        .then((_) => {
